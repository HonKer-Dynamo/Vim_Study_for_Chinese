# 使用方法
首先复制成副本再在学习（因为中途会修改文件内容）
```shell
copy Vimtutor_Chinese  demo
```
Vimtutor是源文件  demo是复制后的副本文件

#使用VIM打开文件开始学习
```shell
vim demo
```
Vimtuto_Chineser文件下载地址：
123盘：https://www.123pan.com/s/o9zUVv-Nxj9h.html
提取码:6666

#如果不想下载可以自行新建文件后复制粘贴内容
```shell
vim demo
```
以上的命令会新建一个文件
Vimtutor_Chinese内容如下：
```text
===============================================================================
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
```
特别说明：本文件来自Kali Linux安装中文环境后使用Vimtutor命令打开的内容。
